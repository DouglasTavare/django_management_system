...
def test_create_product(api_client) -> None:  
    ...
    response_read = api_client.get(f"/products/{product_id}", format="json")  
    assert response_read.status_code == 200  
    assert response_read.data["name"] == payload["name"]

@pytest.mark.django_db  
def test_create_product_with_invalid_data(api_client) -> None:
    """  
    Test the create product API  
    :param api_client:  
    :return: None  
...
@pytest.mark.django_db  
def test_get_product(api_client) -> None:
    """  
...
@pytest.mark.django_db  
def test_put_product(api_client) -> None:  
    """  
    Test the update product API  
    :param api_client:  
    :return: None  
...
@pytest.mark.django_db  
def test_delete_product(api_client) -> None:  
    """  
    ...
    # Delete the product  
    response_delete = api_client.delete(f"/products/{product_id}", format="json")  
    ...
    # product doesn't exist  
    response_delete = api_client.delete(f"/products/{product_id + 1}", format="json")  
